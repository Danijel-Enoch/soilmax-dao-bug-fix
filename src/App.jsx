...
import DAOMinting from "./pages/minting";
  ...
  return (
    <>
      ...
      <Routes>
        <Route
          ...
          element={
            !address ? (
              ...
              <DAOMinting editionDropAddress={editionDropAddress} />
            )
          }
        />
        {/* <Route
          path="/dao/minting"
          element={<DAOMinting editionDropAddress={editionDropAddress} />}
        /> */}
        <Route
          path="/dao/membership"
          element={
        ...
        />
        <Route path="/dao/createContract" element={<CreateContract />} />
      </Routes>
    </>
